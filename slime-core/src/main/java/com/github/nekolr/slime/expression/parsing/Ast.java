...
package com.github.nekolr.slime.expression.parsing;

import com.github.nekolr.slime.expression.DynamicMethod;
...
import com.github.nekolr.slime.expression.interpreter.AstInterpreter;
import com.github.nekolr.slime.expression.interpreter.JavaReflection;
import com.github.nekolr.slime.expression.parsing.ArrayLikeLambdaExecutor.*;
...
//                        Integer size = (Integer) arrLikeObj.getClass().getDeclaredField("length").get(arrLikeObj);
    ...
    public static class MethodCall extends Expression {
         ...
         * {@link Ast.MemberAccess#setCachedMember(Object)}.
         **/
